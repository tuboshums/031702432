...
def get_province():
    pros=[]
    pros.append(["北京","天津","上海","重庆","河北","山西","辽宁","吉林","黑龙江","江苏","浙江","安徽","福建","江西","山东","河南","湖北","湖南","广东","海南","四川","贵州","云南","陕西","甘肃","青海","台湾","内蒙古自治区","广西壮族自治区","西藏自治区","宁夏回族自治区","新疆维吾尔自治区"])
    return pros
...
def fall(addresss):
    ...
    for i in range(len(sheng[0])):
        ...
        if(j):
            ...
            #if i>26:
            #     di=di+'区'
            #小白,新疆维吾尔自治区12322132123乌鲁木齐市新陈村北路32号.
            break
